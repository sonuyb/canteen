...
export const paestrys=[
   {
      ...
      price:"RS.85",
   ...
   
       {
          ...
          name:'CHOCO-TRUFFLE',
          img1:"./images/truffle.jfif",
          detail:"Chocolate truffle cake is a dense moist chocolate cake with silky shavings on top.",
          price:"RS.70",
       ...
       },
       {
          ...
          name:'STRAWBERRY',
          img1:"./images/strawberry.jfif",
          detail:"Strawberry Pastry has great flavor as well as smoothness and is a very versatile food and white whipped cream, White Truffle",
          price:"RS.65",
       },
      { id:18,
          name:'VANCHO',
...
export const beverages=[
   ...
   },
   {
      ...
      name:'COFFEE',
      img1:"./images/cofee.jpg",
      detail:"Coffee is a drink prepared from roasted coffee beans. Darkly colored, bitter, coffee has a stimulating effect on humans",
      price:"RS.12",
   },
   {
      id:33,
      name:'LIME',
      img1:"./images/lime.jpg",
      detail:" Lime juice is made from freshly squeezed limes. This drink can be sweetened or unsweetened.lime juice is key in making limeade.",
      price:"RS.20",
   },
   {
      id:34,
   ...
   },
   {
      ...
      name:'BLUELADY',
      img1:"./images/bmojito.jpg",
      detail:"A combination of mint,lime,soda,Blue Curaçao creates absolutely gorgeous.",
      price:"RS.100",
   },
   {
      id:38,
      name:'PAASIONPUNCH',
      img1:"./images/pmojito.jpg",
      detail:"Passion fruit, passion fruit ice, passion fruit juice, soda water,creates absolutely gorgeous",
      price:"RS.120",
   },
   {
      id:39,
      name:'GREENAPPLE',
      img1:"./images/gmojito.jpg",
      detail:"Green Apple Mojito is prepared with  green applesyrup,lemon juice,soda,mintleaves ",
      price:"RS.110",
   },
   {
      id:40,
...
export const icecreams=[
   ...
   },
   {
      ...
      name:'CHOCOLATE',
      img1:"./images/chocoicecream.jpg",
      detail:"Chocolate ice cream is ice cream with natural or artificial chocolate flavoring.which contain layerings that include nuts,fruit,caramel",
      price:"RS.30",
   },
   {
      id:44,
   ...
   },
   {
      ...
      name:'CHOCOBAR',
      img1:"./images/chocobar.jpg",
      detail:"A chocolate bar is a confection containing chocolate, which contain layerings that include nuts,fruit,caramel",
      price:"RS.20",
   },
   {
      id:46,
   ...
   },
   {
      ...
      name:'BERRYBAR',
      img1:"./images/berrybar.jpg",
      detail:"It has a slushy frozen texture, but tastes nothing like ice cream.pick up any flavor from the berries or any sweetness",
      price:"RS.40",
   },
   {
      id:48,
      name:'ORANGEBAR',
      img1:"./images/orangebar.jpg",
      detail:"Orange bar recipe is made with fresh squeezed orange juice and makes delicious treat on a hot summer's day",
      price:"RS.30",
   },
]
